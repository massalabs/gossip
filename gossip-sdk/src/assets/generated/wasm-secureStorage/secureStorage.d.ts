...
export function writeNamespaceData(
  namespace: number,
  offset: number,
  data: Uint8Array
): void;
export function readNamespaceData(
  namespace: number,
  offset: number,
  len: number
): Uint8Array;
...
export interface InitOutput {
  ...
  readonly rust_sqlite_wasm_assert_fail: (
    a: number,
    b: number,
    c: number,
    d: number
  ...
  readonly closure684_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure119_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen_4ff58544a6cb9b0___convert__closures_____invoke______: (
    a: number,
    b: number
  ) => void;
  readonly closure23_externref_shim_multivalue_shim: (
    a: number,
    b: number,
    c: any
  ) => [number, number];
  readonly closure730_externref_shim: (
    a: number,
    b: number,
    c: any,
    d: any
