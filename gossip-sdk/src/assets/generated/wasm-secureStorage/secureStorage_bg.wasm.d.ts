...
export const closure60_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
...
export const closure751_externref_shim: (a: number, b: number, c: any, d: any) => void;
