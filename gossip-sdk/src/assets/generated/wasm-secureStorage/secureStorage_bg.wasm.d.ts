...
export const wasm_bindgen_b3ea05ef1784c7d3___convert__closures_____invoke______: (a: number, b: number) => void;
export const closure662_externref_shim: (a: number, b: number, c: any) => void;
export const closure89_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
export const closure718_externref_shim: (a: number, b: number, c: any, d: any) => void;
