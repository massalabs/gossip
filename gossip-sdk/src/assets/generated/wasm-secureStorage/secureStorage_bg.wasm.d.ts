...
export const closure101_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
export const closure105_externref_shim: (a: number, b: number, c: any) => void;
export const closure671_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen_c8f7f980e6f4097b___convert__closures_____invoke______: (a: number, b: number) => void;
export const closure727_externref_shim: (a: number, b: number, c: any, d: any) => void;
