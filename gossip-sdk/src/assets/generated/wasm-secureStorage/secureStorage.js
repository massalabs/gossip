...
/**
 * Check if IDB has existing data (for needsUnlock detection before init).
 ...
 *
 * `backend`: `"memory"` (no persistence) or `"idb"` (IndexedDB, production).
 * @param {string} domain
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_idbGetAll_4a0f818843a3db11 = function () {
    return handleError(function () {
      const ret = idbGetAll();
      return ret;
    }, arguments);
  };
  imports.wbg.__wbg_idbHasAnyData_c5a1ad7512cc8faf = function () {
    return handleError(function () {
      const ret = idbHasAnyData();
      return ret;
    }, arguments);
  };
  imports.wbg.__wbg_idbOpen_cc4f975b76cff168 = function () {
    return handleError(function () {
      const ret = idbOpen();
      return ret;
    }, arguments);
  };
  imports.wbg.__wbg_idbPutBatch_e3908933530c0c8a = function () {
    return handleError(function (arg0) {
      const ret = idbPutBatch(arg0);
      return ret;
    }, arguments);
  };
  ...
  imports.wbg.__wbindgen_cast_dd25f90758d17e37 = function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { dtor_idx: 643, function: Function { arguments: [Externref], shim_idx: 644, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
    const ret = makeMutClosure(arg0, arg1, 643, __wbg_adapter_12);
    return ret;
  };
