...
export const execute: (a: number, b: number, c: any) => [number, number, number];
export const flushEncrypted: () => any;
export const flushIdb: () => any;
export const initBordercrypt: (a: number, b: number, c: number, d: number) => any;
...
export const closure708_externref_shim: (a: number, b: number, c: any, d: any) => void;
