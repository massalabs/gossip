...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-muted dark:bg-card mx-auto h-(--bottom-nav-height) app-max-w flex items-center justify-center shadow-2xl z-50">
