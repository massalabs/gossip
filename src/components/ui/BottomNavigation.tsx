...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-card mx-auto h-[var(--bottom-nav-height)] app-max-w flex items-center justify-center shadow-2xl z-50 border-t border-border">
